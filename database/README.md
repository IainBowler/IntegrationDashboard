...
```bash
sqlpackage /Action:Publish /SourceFile:bin/Debug/IntegrationDashboard.Database.dacpac /TargetServerName:localhost /TargetDatabaseName:IntegrationDashboard.Database
```
